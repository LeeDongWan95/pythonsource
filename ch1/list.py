...
result2 = [num for num in range(1, 101) if num % 2 == 1]
result2
# %%
list1 = ["nice", "study", "python", "anaconda", "!"]
# 5글자 이상의 요소만 담아서 새로운 리스트로 생성
result3 = [x for x in list1 if len(x) >= 5]
result3
...
result4 = [x for x in list2 if x.islower()]
result4
# %%
# [1,2,3,4] ==> [2,4,6,8]
