...
print("T","E","S","T") # T E S T 한칸씩 공백이 생김
...
print("%d" % 100)
print("%5d" % 100)
print("%05d" % 100) # 전체 자릿수에서 빈자리에 0 채우기
print() # 엔터한번
print("%s" % "hi") 
print("%5s" % "hi")
print()
# 전체자릿수 : 8 (소수점 자리수 2개 포함)
print("%-8.2f" % 123.21) # - : 왼쪽정렬
print("%8.2f" % 123.21)
print("%8.2f" % 123.215647) # 소수점2자리까지(반올림)
...
# format() + 인덱스 + 정렬
print("{0:<10}".format("hi")) # 전체자리수 10자리 왼쪽정렬
